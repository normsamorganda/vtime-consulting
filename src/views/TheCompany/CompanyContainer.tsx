...
const CompanyContainer = () => {
  ...
  return (
    ...
    <div className="w-3/4 mx-auto text-justify my-12">
        ...
        <p className="mt-8 text-xs lg:text-sm">Established in the year 2000, <span className="text-[#2a9df4] text-xs lg:text-sm">FH International Consulting Co. Inc </span>is a distinguished business consultancy firm that extends its services to aid aspiring entrepreneurs in setting up their businesses in the <span className="text-[#2a9df4] text-xs lg:text-sm">PHILIPPINES</span>. Our areas of expertise include legal and accounting advisory and HR outsourcing services.</p>
