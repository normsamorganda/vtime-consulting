    ...
    <div className="flex flex-col justify-center text-left w-3/5 mx-auto my-12">
        ...
        <Text
          ...
          className={cx('text-black mt-5 leading-6 text-justify', 'tablet:!text-sm', 'phone:!text-[12px]')}>
            At <span className="text-[#2a9df4]">FHI International Consulting Co. Inc.</span>, we provide you with everything you need to enter the <span className="text-[#2a9df4]">PHILIPPINE</span> Market.
