...
<div className="w-full mt-12">
    <div className="bg-[#fefefe] text-[10px] flex flex-col justify-between w-[350px] shadow-lg mx-auto shadow-brown-500/50 mt-2 rounded-lg md:w-[850px] md:text-xl md:flex-row">
